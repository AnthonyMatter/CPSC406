...
class Transition{
    public:
        ...
        int count = 0;
        vector<string> convertedState(vector<string> transition, vector<string> startState, string alpha, string transitionState);
        ...
        void createDFAStates(vector<std::string> transfer, vector<NFAState*> states, vector<std::string> alphabet, std::string start, vector<NFAState*> statesOfNFA);
        ...
        vector<string> computeNextState(vector<string> transitionState, vector<string> potentialNextState, string sigma, string newTransition);
        bool containsEmptyState(vector<string> myvec);
